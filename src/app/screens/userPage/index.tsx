            ...
            <Box className={"order-info-box"}>
              ...
              >
                <div className={"order-user-img"}>
                  <img
                         src={authMember?.memberImage ? `${sereverAPI}/${authMember.memberImage}` : "/icons/default-user.svg"}
              ...
              <Box className={"user-media-box"}>
               ...
               <p className={"user-desc"}>{authMember?.memberDescription ? authMember.memberDescription : "no description"}</p>
            </Box>
          </Stack>
        </Stack>
      </Container>
